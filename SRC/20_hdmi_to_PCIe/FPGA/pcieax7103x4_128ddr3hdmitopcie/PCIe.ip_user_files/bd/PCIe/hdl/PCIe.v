...
module PCIe
  ...
  assign S0_AXI_1_AWID = S0_AXI_awid[5:0];
  ...
  assign S0_AXI_1_WDATA = S0_AXI_wdata[63:0];
  assign S0_AXI_1_WLAST = S0_AXI_wlast;
  assign S0_AXI_1_WSTRB = S0_AXI_wstrb[7:0];
  assign S0_AXI_1_WVALID = S0_AXI_wvalid;
  assign S0_AXI_awready = S0_AXI_1_AWREADY;
  assign S0_AXI_bid[5:0] = S0_AXI_1_BID;
  ...
  PCIe_axi_interconnect_0_1 axi_interconnect_0
       (.ACLK(clk_wiz_0_clk_out3),
        ...
        .S01_AXI_awaddr(S0_AXI_1_AWADDR),
        .S01_AXI_awburst(S0_AXI_1_AWBURST),
        .S01_AXI_awcache(S0_AXI_1_AWCACHE),
        .S01_AXI_awid(S0_AXI_1_AWID),
        .S01_AXI_awlen(S0_AXI_1_AWLEN),
        .S01_AXI_awlock(S0_AXI_1_AWLOCK),
        .S01_AXI_awprot(S0_AXI_1_AWPROT),
        .S01_AXI_awqos(S0_AXI_1_AWQOS),
        .S01_AXI_awready(S0_AXI_1_AWREADY),
        .S01_AXI_awregion(S0_AXI_1_AWREGION),
        .S01_AXI_awsize(S0_AXI_1_AWSIZE),
        .S01_AXI_awvalid(S0_AXI_1_AWVALID),
        .S01_AXI_bid(S0_AXI_1_BID),
        .S01_AXI_bready(S0_AXI_1_BREADY),
        .S01_AXI_bresp(S0_AXI_1_BRESP),
        .S01_AXI_bvalid(S0_AXI_1_BVALID),
        .S01_AXI_wdata(S0_AXI_1_WDATA),
        .S01_AXI_wlast(S0_AXI_1_WLAST),
        .S01_AXI_wready(S0_AXI_1_WREADY),
        .S01_AXI_wstrb(S0_AXI_1_WSTRB),
        .S01_AXI_wvalid(S0_AXI_1_WVALID));
...
module s01_couplers_imp_1YMHHZR
  ...
  wire [5:0]s01_couplers_to_auto_us_AWID;
  ...
  wire [5:0]s01_couplers_to_auto_us_BID;
  ...
  assign S_AXI_bid[5:0] = s01_couplers_to_auto_us_BID;
  ...
  assign s01_couplers_to_auto_us_AWID = S_AXI_awid[5:0];
