...
#
# Generated by Vivado on Thu Sep 07 13:58:32 +0800 2017
...
# Script info
echo -e "pll.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../ov5642_ddr3_lcd.srcs/sources_1/ip/pll_1/pll_clk_wiz.v" \
    "$ref_dir/../../../../ov5642_ddr3_lcd.srcs/sources_1/ip/pll_1/pll.v" \
  2>&1 | tee -a vlogan.log
