...
#
# Generated by Vivado on Thu Sep 07 14:43:45 +0800 2017
...
# Script info
echo -e "wrfifo.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot wrfifo xil_defaultlib.wrfifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim wrfifo -key {Behavioral:sim_1:Functional:wrfifo} -tclbatch cmd.tcl -log simulate.log
}
